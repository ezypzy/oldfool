				...
				<form action="" class="form-horizontal" method="post">
					<fieldset>
						<div class="control-group <?php if( $form_error_address1 ){ ?>error<?php } ?>">
							...
							<div class="controls">
								<input type="text" class="input-xlarge" name="address1" value="<?php echo $input['address1'];?>">
							</div>
						</div>
						...
						<div class="control-group <?php if( $form_error_address2 ){ ?>error<?php } ?>">
							...
							<div class="controls">
								<input type="text" class="input-xlarge" name="address2" value="<?php echo $input['address2'];?>">
							</div>
						</div>
						...
						<div class="control-group <?php if( $form_error_address3 ){ ?>error<?php } ?>">
							<label class="control-label"></label>
							<div class="controls">
								<input type="text" class="input-xlarge" name="address3" value="<?php echo $input['address3'];?>">
							</div>
						</div>
						...
						<div class="control-group <?php if( $form_error_postcode ){ ?>error<?php } ?>">
							...
							<div class="controls">
								<input type="text" class="input-medium" name="postcode" value="<?php echo $input['postcode'];?>">
							</div>
						</div>
						...
						<div class="control-group <?php if( $form_error_city ){ ?>error<?php } ?>">
							...
							<div class="controls">
								<input type="text" class="input-medium" name="city" value="<?php echo $input['city'];?>">
							</div>
						</div>
